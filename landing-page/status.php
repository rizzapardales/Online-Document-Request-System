<?php
    ...
    $ref1 = isset($_SESSION['reference']) ? $_SESSION['reference'] : '';
    $receipt1 = isset($_SESSION['receipt']) ? $_SESSION['receipt'] : '';
    $dop1 = isset($_SESSION['dop']) ? $_SESSION['dop'] : '';
    $amount1 = isset($_SESSION['amount']) ? $_SESSION['amount'] : '';


    $claimDate = isset($_SESSION['claim_date']) ? $_SESSION['claim_date'] : '';
...
<body>
   ...
   <div class="container">
        <div class="content2" id="content2">
            ...
            <div class="maindocu">
                ...
                if (isset($_POST['reference_num'])) {
                    ...
                    $sql = "SELECT * FROM tbl_request_student WHERE reference_num = '$refNum'";
        ...
        <div class="content1" id="content1">
            ...
            <form class="form" action="status_progress.php" method="POST" enctype="multipart/form-data">
            ...
            <form class="form" action="generate.php" method="POST">
                    <input type="text"  id="refnum" name="refnum"  value="<?php echo isset($ref1) ? $ref1 : '' ?>" hidden>
                    <input type="number"  id="receipt" name="receipt"  value="<?php echo isset($receipt1) ? $receipt1 : '' ?>" hidden>
                    <input type="number" id="amount" name="amount" value="<?php echo isset($amount1) ? $amount1 : '' ?>" hidden>
                    <input type="date" id="date" name="date" placeholder="MM/DD/YYYY" value="<?php echo isset($dop1) ? $dop1 : ''?>" hidden>
