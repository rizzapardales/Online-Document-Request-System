...
$result = mysqli_query($connString, "SELECT * FROM tbl_request_client WHERE reference_num='$refnum'");
$header = mysqli_query($connString, "SHOW columns FROM tbl_request_client");
