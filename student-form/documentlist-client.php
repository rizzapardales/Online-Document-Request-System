<?php
    ...
    $ref_num_cl = $_SESSION['ref_num_cl'];
    $name_cl = $_SESSION['name_cl'];
    $query_run = null;
    ...
    if(isset($_POST['save_multiple_checkbox'])) {
        ...
        if (is_array($documents)) {
            foreach ($documents as $key => $document) {
                ...
                $query = "INSERT INTO tbl_document_request (for_refnum, document_id, num_copies, amount) VALUES ('$ref_num_cl', '$document', '$numcopy', '$amountValue')";
        ...
        if($query_run){
            ...
            $total_amount_cl = $_SESSION['total'] = $total;
    ...
    if(isset($_POST['total_amount'])) {
        ...
        $query2 = "UPDATE tbl_request_client SET total_amount = '$total' WHERE reference_num = '$ref_num_cl'";
...
<head>
    ...
    <link rel="stylesheet" href="documentlist-style.css">
...
<input type="hidden" id="status" value="<?php echo isset($status) ? $status : '' ?>">
    ...
    <main>
        <div class="document-container">
            ...
            <form action="../landing-page/generateref_client.php" method="POST">
                    <input type="text" value="<?php echo $ref_num_cl ?>" name="ref_cl" id="ref_cl" hidden>
                    <input type="text" value="<?php echo $name_cl ?>" name="name_cl" id="name_cl" hidden>
                    <input type="text" value="<?php echo $total_amount_cl ?>" name="total_cl" id="total_cl" hidden>
                    ...
                    <div class="popup-container">
                        <div class="popup" id="popup">
                            ...
                            <p class="bold-text">Reference Number: <?php echo $ref_num_cl ?> </p>
    ...
    <script>
            ...
            function closePopup() {
                ...
                location.href="../student-form/documentlist-client.php";
            }
